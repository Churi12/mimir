...
// newCategorizedWarning builds a categorized warning whose message is formatted
// from format and args, identically to fmt.Errorf.
func newCategorizedWarning(category WarningCategory, format string, args ...any) *categorizedWarning {
...
// info-level annotations. It is the shared classification used both by the
// Prometheus OTLP write handler and, via vendoring, by Mimir's distributor.
